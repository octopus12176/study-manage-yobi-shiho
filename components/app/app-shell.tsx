...
export function AppShell({ children, streak }: AppShellProps) {
  ...
  return (
    <div className='relative min-h-screen bg-bg text-text'>
      ...
      <header className='mobile-header sticky top-0 z-50 hidden items-center justify-between border-b border-border bg-[rgba(246,245,241,0.88)] px-4 py-3 backdrop-blur-xl'>
      ...
      <div className='main-area'>
        <div className='mx-auto max-w-[960px] px-5 pb-10 pt-6 md:px-8'>
